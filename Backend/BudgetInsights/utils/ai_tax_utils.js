...
async function generateAISummary(baseReport) {
    try {
        ...
        - Ensure the content is concise, informative, and tailored to the user's needs and the font style is easy to read no bold. 
        - I want the data to be around 10 lines.
